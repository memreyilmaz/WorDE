...
import com.WorDE.android.app.ui.AssignTitle;
import com.WorDE.android.app.ui.DrawerActivity;
import com.WorDE.android.app.ui.detail.WordDetailFragment;

import static com.WorDE.android.app.Config.FRAGMENT_DETAIL;
import static com.WorDE.android.app.Config.FRAGMENT_LIST;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (fragmentManager.findFragmentByTag(FRAGMENT_DETAIL) != null){
                ...
                } else if (fragmentManager.findFragmentByTag(FRAGMENT_LIST) == null){
                   fragmentManager.beginTransaction().remove(wordDetailFragment).commit();
                }
            }else {
                if (mTwoPaneLayout) {
